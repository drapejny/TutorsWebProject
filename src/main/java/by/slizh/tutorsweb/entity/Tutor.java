...
public class Tutor extends User {
    ...
    public Tutor(int userId, String firstName, String lastName, String email, String phone, String city, InputStream photo, Role role, Status status, int tutorId, String education, String info, BigDecimal pricePerHour, String rejectionMessage) {
        super(userId, firstName, lastName, email, phone, city, photo, role, status);
