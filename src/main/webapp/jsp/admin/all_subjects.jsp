...
<div class="wrapper">
    ...
    <main class="main">
        <c:forEach var="element" items="${applicationScope.subjects}" varStatus="status">
            ${element.subjectName} <a
                href="${pageContext.request.contextPath}/controller?command=delete_subject&subject_id=${element.subjectId}"><fmt:message
                key="subjects.delete"/></a>
            <hr>
        </c:forEach>
